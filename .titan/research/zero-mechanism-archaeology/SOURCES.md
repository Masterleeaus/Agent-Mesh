...
Repository:
Masterleeaus/Agent-Mesh
Branch:
main
Commit:
cac042dc94ccdd5855351dd82c5989478bab27a2
Path:
AGENTS.md
Inspected:
YES
...
FINDING-GH-001
Notes:
Execution contract and documentation hierarchy. Code is implemented truth; canonical docs are authoritative product/architecture truth; archive/generated material is evidence only.
...
agent/763
Commit:
0fec891a78279048c789aa6beaf5eaa486bf65ad
Path:
.github/workflows/titan-zero-mechanism-archaeology.yml
Inspected:
YES
Relevant findings:
FINDING-GH-005; FINDING-GH-006
Notes:
Read-only mechanism-first archaeology workflow. Current implementation plus reachable Git history. Heuristic evidence only.
...
Masterleeaus/Agent-Mesh
Source:
User-supplied architecture pivot
Path:
Pasted markdown (20260922-105957).md
Inspected:
YES
Relevant findings:
FINDING-GH-003; FINDING-GH-004
Notes:
Governing pivot for this archaeology mission. Defines HUMAN=ONE / DIGITAL WORKING INTELLIGENCE=ZERO, mechanism-first search, memory distinction, learning/authority separation, Trust progression and Evolution Engine.
...
main
Commit:
cb1ab5e507588ea35bb624a2a97ce22e04b4ac4c
Path:
.git repository state / main baseline
Inspected:
YES
Relevant findings:
