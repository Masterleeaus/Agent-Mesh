...
export const AssignedJobsPage: FC = () => {
  ...
  return (
    <div style={{ padding: 24 }}>
      <h1 style={{ margin: '0 0 16px', fontSize: 22, fontWeight: 700, color: '#e6ecf5' }}>Assigned Jobs</h1>
      <Card variant="bordered" style={{ marginBottom: 16 }}>
        <SearchBar value={search} onChange={setSearch} placeholder="Search assigned jobs..." />
      </Card>
      ...
      {!loading && !error && jobs.length === 0 && <EmptyState title="No assigned jobs" description="You have no jobs assigned to you." />}
