...
export const Disputes: FC<DisputesProps> = ({ count, loading }) => {
  ...
  return (
    <Card variant="bordered" style={{ borderTop: '3px solid #f04438', padding: 16 }}>
      <p style={{ margin: 0, fontSize: 12, color: '#8b9bb5', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Active Disputes</p>
