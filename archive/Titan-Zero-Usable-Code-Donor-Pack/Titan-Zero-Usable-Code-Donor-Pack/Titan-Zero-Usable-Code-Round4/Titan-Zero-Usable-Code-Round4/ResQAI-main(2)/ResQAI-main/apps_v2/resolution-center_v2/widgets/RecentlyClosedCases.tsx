...
interface RecentlyClosedCasesProps {
  count?: number;
  loading?: boolean;
}

export const RecentlyClosedCases: FC<RecentlyClosedCasesProps> = ({ count, loading }) => {
  ...
  return (
    <Card variant="bordered" style={{ borderTop: '3px solid #12b76a', padding: 16 }}>
      <p style={{ margin: 0, fontSize: 12, color: '#8b9bb5', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Recently Closed</p>
