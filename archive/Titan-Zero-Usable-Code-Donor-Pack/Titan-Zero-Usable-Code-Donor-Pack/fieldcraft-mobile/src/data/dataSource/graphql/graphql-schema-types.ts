...
export type Query = {
  ...
  historyById: History;
  latestHistoryByProjectId: History;
  material: Materials;
...
export type QueryLatestHistoryByProjectIdArgs = {
  projectId: Scalars['String'];
};
...
export type GetProjectListQuery = { __typename?: 'Query', filterProjects: Array<{ __typename?: 'Projects', projectName: string, reference: string, projectAdress: string, id: string }> };
...
export type HistoryQuery = { __typename?: 'Query', latestHistoryByProjectId: { __typename?: 'History', state: string, createdAt: any } };
...
export type MaterialFieldsFragment = { __typename?: 'Materials', materialName: string, quantity: number };
...
export type CreateMaterialMutation = { __typename?: 'Mutation', createMaterial: { __typename?: 'Materials', projectId: string, price: number, description: string, categoryId: string, materialState: string, id: string, materialName: string, quantity: number } };
...
export type GetMaterialQuery = { __typename?: 'Query', filterMaterials: Array<{ __typename?: 'Materials', created_by_id: string, projectId: string, price: number, description: string, categoryId: string, materialState: string, id: string, materialName: string, quantity: number }> };
...
export type GetMaterialListQuery = { __typename?: 'Query', filterMaterials: Array<{ __typename?: 'Materials', id: string, materialName: string, quantity: number }> };
...
export type UploadFileMutation = { __typename?: 'Mutation', uploadFile: { __typename?: 'Images', materialtId: string, imagePath: string } };
...
export type UpdateMaterialMutation = { __typename?: 'Mutation', updateMaterial: { __typename?: 'Materials', materialState: string, categoryId: string, description: string, projectId: string, price: number, created_by_id: string, id: string, materialName: string, quantity: number } };
