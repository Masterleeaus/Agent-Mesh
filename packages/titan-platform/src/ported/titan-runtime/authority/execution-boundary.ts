// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-runtime/authority/execution-boundary.mjs
import { assertAuthorityCompanyId, rejectLegacyAuthorityBoundaryDeep } from './company-boundary.js';
import { assertAuthorityDecisionAllowsExecution, assertAuthorityDecisionSupersessionContinuity } from './authority-evaluator.js';
