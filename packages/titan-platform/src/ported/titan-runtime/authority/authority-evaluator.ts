// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-runtime/authority/authority-evaluator.mjs
import { assertAuthorityCompanyId, rejectLegacyAuthorityBoundaryDeep } from './company-boundary.js';
import { createWorkerIdentity, createAuthorityRequirement, createApprovalState } from './worker-authority.js';
import { normalizeVerifiedAutonomySnapshot, computeContractionOnlyAuthority } from './autonomy.js';
import { isProtectedAction } from './protected-actions.js';
