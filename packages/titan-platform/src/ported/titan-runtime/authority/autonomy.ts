// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-runtime/authority/autonomy.mjs
import { assertAuthorityCompanyId, rejectLegacyAuthorityBoundaryDeep } from './company-boundary.js';
import { normalizeAuthorityDecisionProvenance, evaluateAuthorityDecisionLease } from './authority-lease.js';
import { normalizeAuthorityDelegation } from './delegation.js';
