// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-runtime/interaction-engine/conversation-state-runtime.mjs
import { assertCanonicalCompanyId, rejectLegacyTenantAuthority } from '../boundary.js';
import { canonicalSurface, createInteractionContext } from './contracts.js';
import { createConversationState } from './state.js';
