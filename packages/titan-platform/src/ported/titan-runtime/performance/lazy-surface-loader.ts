// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-runtime/performance/lazy-surface-loader.mjs
const DEFAULT_SURFACES = Object.freeze({
  'diagnostics.bootstrapProfiler': Object.freeze({kind:'module', path:'../../diagnostics/startup/bootstrap-performance-profiler.js', startup_required:false, company_scoped:false}),
  'workforce.graph': Object.freeze({kind:'module', path:'../../titan-workforce/graph/workforce-graph.js', startup_required:false, company_scoped:true}),
