// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-offline/verify.mjs
import assert from 'node:assert/strict';
import {createRestartCheckpointStore,isTerminalRuntimeType} from './restart-checkpoint.js';
function memoryDb(){
