// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-workforce/customer-care/complaint-intake.mjs
import { createCustomerCareCase } from './customer-care-contract.js';
