// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-workforce/customer-care/resolved-service-handoff.mjs
import { CUSTOMER_CARE_CONTRACT, buildCustomerCareHandoff } from './customer-care-contract.js';
