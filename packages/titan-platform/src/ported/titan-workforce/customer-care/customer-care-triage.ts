// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-workforce/customer-care/customer-care-triage.mjs
import {
  assessCustomerCareEscalation,
  transitionCustomerCareCase
} from './customer-care-contract.js';
import {
  buildFeedSeverityEnvelope,
  workforceUrgencyForSeverity
} from '../../titan-runtime/feed/feed-severity.js';
