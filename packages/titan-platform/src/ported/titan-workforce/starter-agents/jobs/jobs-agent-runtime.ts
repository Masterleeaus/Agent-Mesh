// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-workforce/starter-agents/jobs/jobs-agent-runtime.mjs
import {compileJobCreationContext,dedupeJobCreation} from './jobs-context-bridge.js';
import {evaluateJobTransition} from './jobs-lifecycle-contract.js';
import {buildWorkOrderTransitionCommand,applyWorkOrderTransitionResult} from './jobs-work-order-adapter.js';
import {buildJobFieldContext} from './jobs-field-context.js';
import {buildOfflineJobMutation,assessOfflineReplay,detectJobRevisionConflict} from './jobs-offline-sync.js';
import {evaluateJobEvidence,createJobEvidenceHandoff} from './jobs-evidence-policy.js';
import {classifyJobException,planExceptionResolution} from './jobs-exception-runtime.js';
import {evaluateJobCompletionReadiness,buildCompletionHandoffs} from './jobs-completion-readiness.js';
import {compileJobsSettings,jobsSettingsToPolicies} from './jobs-settings.js';
