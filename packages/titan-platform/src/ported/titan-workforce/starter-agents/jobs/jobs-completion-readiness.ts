// @ts-nocheck
// Ported from Titan Zero extension (ui-or-browser-adaptation): titan-workforce/starter-agents/jobs/jobs-completion-readiness.mjs
// QUARANTINE: not exported to standalone runtime until browser/DOM dependencies are adapted.
import {missingOperationalPrerequisites} from './jobs-field-context.js';
import {evaluateJobEvidence} from './jobs-evidence-policy.js';
import {canSilentlyCompleteWithExceptions} from './jobs-exception-runtime.js';
