...
import contributions from '../../titan-capabilities/native-contributions.json' with { type: 'json' };
import { prepareAtomicWorkerExecution } from './atomic-worker-tool-binding-runtime.js';
