// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-workforce/hierarchy/atomic-worker-tool-binding-runtime.mjs
import bindings from './atomic-worker-tool-bindings.json' with { type: 'json' };
import { loadToolRegistry, getToolDefinition } from '../../titan-tools/tool-registry.js';
