// @ts-nocheck
// Ported from Titan Zero extension (portable-core): titan-workforce/customer-care/customer-care-inventory.mjs
...
export const CUSTOMER_CARE_SURFACE_INVENTORY = Object.freeze({
  ...
  existing_surfaces: Object.freeze({
    conversation_state: [
      ...
      'titan-runtime/interaction-engine/conversation-state-runtime.js',
    ...
    workforce_governance: [
      'titan-workforce/decision/decision-rights-runtime.js',
      'titan-workforce/gateway/AuthorityAutonomyBinding.schema.json',
      'titan-workforce/gateway/ProposalLifecycle.schema.json',
      'titan-workforce/notifications/workforce-notification-escalation-runtime.js'
    ]
  }),
