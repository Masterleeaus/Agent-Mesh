// @ts-nocheck
// Ported from Titan Zero extension (ui-or-browser-adaptation): titan-runtime/authority/authority-lease.mjs
// QUARANTINE: not exported to standalone runtime until browser/DOM dependencies are adapted.
import { assertAuthorityCompanyId, rejectLegacyAuthorityBoundaryDeep } from './company-boundary.js';
import { evaluateDelegationExtinction } from './delegation.js';
import { applyAuthorityLeaseControl } from './lease-control.js';
