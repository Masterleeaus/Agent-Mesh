...
['Your Zero','/your-zero','Your persistent digital working intelligence learns the business, your role, corrections, experience and changing context.'],
['AI Workforce','/ai-workforce','Zero coordinates specialist capabilities so owners do not have to choose and micromanage agents.'],
...
['Command, Go & Hub','/apps','Focused experiences for owners and managers, field teams and customers around the same Titan Zero environment.'],
...
export default function Features(){return <><section className="pt-32 pb-16 px-6 text-center"><div className="max-w-6xl mx-auto"><SectionLabel>Capabilities</SectionLabel><h1 className="text-4xl sm:text-6xl font-extrabold mb-5">One intelligence system.<br/><span className="text-nx-purple-light">Many connected capabilities.</span></h1><p className="text-lg text-nx-muted max-w-3xl mx-auto">Features is the map of Titan Zero, not a fixed SaaS checklist. Start with Your Zero, then explore the intelligence, workforce, integration, privacy, authority and real-world capabilities around it.</p></div></section>
...
<section className="py-20 px-6"><div className="max-w-5xl mx-auto text-center"><SectionLabel>One + Zero + Team</SectionLabel><h2 className="text-4xl font-extrabold mb-5">Complexity behind Zero.</h2><p className="text-lg text-nx-muted">Customers generally ask Zero for outcomes rather than selecting models, APIs or agents. Titan coordinates the appropriate capabilities, connected systems, evidence and authority behind the interaction.</p></div></section>
