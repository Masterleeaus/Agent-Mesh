...
const steps = [
  ...
  ['Configure personal Zeros and the workforce', 'We configure the appropriate Zero experience for owners, managers, staff and customers, then connect specialist intelligence, knowledge, permissions, review points and operating rules around those roles.'],
  ['Operate and improve', 'We manage, monitor, maintain and improve the system as the business, software and workflows change.'],
]

const trustStages = [
  ['Observe', 'The relevant Zero observes authorised context and workflows without taking action.'],
  ['Recommend', 'Zero can surface recommendations and the evidence behind them.'],
  ['Prepare', 'Zero prepares the proposed action, message, booking, document or workflow for review.'],
  ['Ask & execute', 'The account holder or another authorised person approves the prepared action before execution.'],
