...
function depDone(p){const L=g.TitanZeroManagerLifecycle;return L&&typeof L.dependencySatisfied==='function'?L.dependencySatisfied(p):['DONE','MERGED','PROMOTED'].includes(life(p));}
...
g.TitanZeroManagerDependencyEngine=freeze({SCHEMA,derive,unlocked});
