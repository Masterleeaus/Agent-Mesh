...
const presentation = Object.freeze({
  go: Object.freeze({
    ...
    greeting: "Your field workspace is ready. I can help with today’s work, access, evidence and what to do next.",
    prompt: "Ask about today’s work, a customer, or what to do next…",
    suggestions: Object.freeze(["What’s my next job?", "Show today’s schedule", "Report an issue"]),
  }),
  hub: Object.freeze({
    name: "Titan Hub",
    audience: "Customers",
    ...
    greeting: "Your customer workspace is ready. I can help with bookings, service updates, invoices and support.",
  ...
  zero: Object.freeze({
    ...
    greeting: "Your Command workspace is ready. I can help with current operations, decisions, workforce and system status.",
