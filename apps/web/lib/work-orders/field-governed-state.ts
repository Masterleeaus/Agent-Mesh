...
export async function recordGovernedInspectionState(client:PoolClient,ctx:{accountId:string;company_id:string;actorId:string;traceId:string},inspection:{inspection_id:string;permit_id:string;work_order_id:string;inspection_date:string;result:string;provenance?:Record<string,unknown>}){
...
export async function recordGovernedDefectState(client:PoolClient,ctx:{accountId:string;company_id:string;actorId:string;traceId:string},defect:{defect_id:string;work_order_id:string;punch_list_id:string;severity:string;state:string;verified_by_ref?:string|null;verified_date?:string|null;defer_reason?:string|null;completion_blockers:readonly string[];provenance?:Record<string,unknown>}){
