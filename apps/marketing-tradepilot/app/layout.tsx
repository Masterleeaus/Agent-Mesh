...
export const metadata: Metadata = {
  title: "Titan Zero — AI-native field service for the trades",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://titanzero.io",
    images: [{ url: "https://titanzero.io/app_icon.png", width: 512, height: 512 }],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Titan Zero Brand Font: Space Grotesk */}
